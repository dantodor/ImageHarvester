...
public class HttpServer {
    ...
    public static class MultipartInputStream extends FilterInputStream {
        ...
        protected boolean fill() throws IOException {
            ...
            if (tail > buf.length - fullBoundary.length - 2) { // room for max boundary
    ...
    /**
     * Sets whether communications will be secure (HTTPS) or not.
     * See {@link #createServerSocket} for configuration details.
     *
     * @param secure specifies whether communications will be secure (HTTPS) or not
     */
     ...
     * <p>
     * For a secure (HTTPS) connection, the appropriate system properties
     ...
     * Alternatively, this method can be overridden to customize it programmatically.
    ...
    protected ServerSocket createServerSocket() throws IOException {
        ServerSocketFactory factory = secure
